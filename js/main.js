...
let products = [
  {
    ...
    productDesc:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum animi similique rerum rem iusto omnis repellat odio.",
    prodPrice: 10000,
    category: "phone",
  ...
  },
  {
    ...
    productImage:
      "https://i.postimg.cc/8zbZxw4j/macbook-pro-space-grey-1-6.webp",
    productDesc:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum animi similique rerum rem iusto omnis repellat odio.",
    prodPrice: 25000,
    category: "macbook",
  ...
  },
  {
    ...
    productImage:
      "https://i.postimg.cc/s2VpSrp2/apple-watch-ultra-lte-49mm-titanium-beige-yellow-trail-loop-1.webp",
    productDesc:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum animi similique rerum rem iusto omnis repellat odio.",
    prodPrice: 5000,
    category: "watch",
  ...
  },
  {
    ...
    productImage:
      "https://i.postimg.cc/rmsxnNZX/apple-watch-series-8-gps-41mm-starlight-alum1-1.webp",
    productDesc:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum animi similique rerum rem iusto omnis repellat odio.",
    prodPrice: 6000,
    category: "watch",
  ...
  },
  {
    ...
    productImage:
      "https://i.postimg.cc/FKD0VBZV/c5044-w-npi-airpods-images-resize-for-online-store-3.webp",
    productDesc:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum animi similique rerum rem iusto omnis repellat odio.",
    prodPrice: 750,
    category: "headphone",
  ...
  },
  {
    ...
    productImage:
      "https://i.postimg.cc/5NCqWp4f/airpods-pdp-image-position-4-wwen-jpg.webp",
    productDesc:
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum animi similique rerum rem iusto omnis repellat odio.",
    prodPrice: 900,
    category: "headphone",
...
if (product) {
      ...
      <div class="row align-items-start">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-8 pt-5">
          ...
          <div class="pt-3">
            <p>${product.productDesc}</p>
            <p>Price: R${product.prodPrice}</p>
            <select class="my-3" id="quantity" name="quantity">
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>  
            </select>
  ...
  productDetailsContainer.innerHTML =
    "<p>No product selected. To see, click on 'View Product' on the Store Page.</p>";
}
...
function displayFeaturedProducts() {
  ...
  featuredProducts.forEach(function (product, index) {
    ...
    productCard.innerHTML = `
      ...
      <li>
      <button class="add mb-5" onclick="addToCart(${product.id})">Add to Cart</button><li></li>
      </li>
      </ul>
    `;
  ...
  let carouselContainer = document.getElementById("carouselExampleInterval");
  carouselContainer.querySelector(".carousel-inner").replaceWith(carouselInner);
  ...
  carouselControlPrev.dataset.bsTarget = "#carouselExampleInterval";
  carouselControlPrev.dataset.bsSlide = "prev";
  ...
  carouselControlNext.dataset.bsTarget = "#carouselExampleInterval";
  carouselControlNext.dataset.bsSlide = "next";
  ...
  carouselContainer
    ...
    .replaceWith(carouselControlPrev);
  carouselContainer
    .querySelector(".carousel-control-next")
    .replaceWith(carouselControlNext);
}
